...
const TwitterModal = ({ 
  ...
  const getModalConfig = () => {
    const configs = {
      firstTime: {
        ...
        message: "Welcome to the Aura community!\n\nWant to earn +150 points?\n• +50 points for connecting Twitter ✅\n• +100 points for following @AURAinWEB3 🐦\n\nClick FOLLOW to open Twitter and earn your points!",
        icon: "🚀",
        confirmText: "🐦 FOLLOW & EARN",
        cancelText: "❌ SKIP",
        points: 150
      },
      existingUser: {
        ...
        greeting: `Hi ${username}! 👋`,
        message: "Want to earn +100 more points?\nJust follow @AURAinWEB3 on Twitter!\n\nClick FOLLOW to open Twitter and earn points!",
        icon: "💰",
        confirmText: "🐦 FOLLOW & EARN",
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      console.error("Twitter modal error:", err);
              ...
              <div className="text-center mb-6">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span>Ready to earn some points?</span>
                  </div>
              ...
              <div className="space-y-4">
                ...
                {showSuccess && (
                  ...
                  >
                    ...
                    <br />
                    <span className="text-sm">Thanks for following! 🐦</span>
                  </div>
                )}
              </div>
            </div>
